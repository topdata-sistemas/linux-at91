...
#define ATMEL_XLCDC_UNUSED			0
#define ATMEL_HLCDC_LAYER_DMA_ROTDIS		ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_OVR			ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_ITER2BL		ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_ITER			ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_LAEN			ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_GAEN			ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_GA(x)			ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_DISCEN		ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_PLANE_HEAD(x)		ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_PLANE_CTRL(x)		ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_PLANE_NEXT(x)		ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_CHDR			ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_RST			ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_CHER			ATMEL_XLCDC_UNUSED
#define ATMEL_HLCDC_LAYER_DFETCH		ATMEL_XLCDC_UNUSED

#define ATMEL_HLCDC_LAYER_CHER			0x10
#define ATMEL_HLCDC_LAYER_CHSR			0x10
#define ATMEL_HLCDC_LAYER_EN			BIT(0)
/*Bits aren't present but defining them like this saves code changes */
#define ATMEL_HLCDC_LAYER_UPDATE		BIT(0)
#define ATMEL_HLCDC_LAYER_A2Q			BIT(0)

#define ATMEL_HLCDC_LAYER_IER			0x0
#define ATMEL_HLCDC_LAYER_IDR			0x4
#define ATMEL_HLCDC_LAYER_IMR			0x8
#define ATMEL_HLCDC_LAYER_ISR			0xc
#define ATMEL_HLCDC_LAYER_DONE_IRQ(p)		BIT(0 + (8 * (p)))
#define ATMEL_HLCDC_LAYER_ERROR_IRQ(p)		BIT(1 + (8 * (p)))
#define ATMEL_HLCDC_LAYER_OVR_IRQ(p)		BIT(2 + (8 * (p)))

#define ATMEL_HLCDC_LAYER_PLANE_ADDR(p)		(((p) * 0x4) + 0x18)

#define ATMEL_HLCDC_LAYER_DMA_CFG		0
#define ATMEL_HLCDC_LAYER_DMA_BLEN_MASK		GENMASK(6, 4)
#define ATMEL_HLCDC_LAYER_DMA_BLEN_SINGLE	(0 << 4)
#define ATMEL_HLCDC_LAYER_DMA_BLEN_INCR4	(1 << 4)
#define ATMEL_HLCDC_LAYER_DMA_BLEN_INCR8	(2 << 4)
#define ATMEL_HLCDC_LAYER_DMA_BLEN_INCR16	(3 << 4)
#define ATMEL_HLCDC_LAYER_DMA_BLEN_INCR32	(4 << 4)
#define ATMEL_HLCDC_LAYER_DMA_BLENCC_MASK	GENMASK(10, 8)
#define ATMEL_HLCDC_LAYER_DMA_BLENCC_SINGLE	(0 << 8)
#define ATMEL_HLCDC_LAYER_DMA_BLENCC_INCR4	(1 << 8)
#define ATMEL_HLCDC_LAYER_DMA_BLENCC_INCR8	(2 << 8)
#define ATMEL_HLCDC_LAYER_DMA_BLENCC_INCR16	(3 << 8)
#define ATMEL_HLCDC_LAYER_DMA_BLENCC_INCR32	(4 << 8)
...
#define ATMEL_HLCDC_CLUT_MODE(m)		\
	(ATMEL_HLCDC_LAYER_CLUT | (((m) & 0x3) << 8))
#define ATMEL_HLCDC_YCC_MODE(m)			\
	(ATMEL_HLCDC_LAYER_YUV | (((m) & 0xf) << 12))
#define ATMEL_HLCDC_GAM				BIT(2)
#define ATMEL_HLCDC_YUV422ROT			BIT(16)
...
#define ATMEL_HLCDC_AYUV_MODE			ATMEL_HLCDC_YCC_MODE(0)
#define ATMEL_HLCDC_YUYV_MODE			ATMEL_HLCDC_YCC_MODE(1)
#define ATMEL_HLCDC_UYVY_MODE			ATMEL_HLCDC_YCC_MODE(2)
#define ATMEL_HLCDC_YVYU_MODE			ATMEL_HLCDC_YCC_MODE(3)
#define ATMEL_HLCDC_VYUY_MODE			ATMEL_HLCDC_YCC_MODE(4)
#define ATMEL_HLCDC_NV61_MODE			ATMEL_HLCDC_YCC_MODE(5)
#define ATMEL_HLCDC_YUV422_MODE			ATMEL_HLCDC_YCC_MODE(6)
#define ATMEL_HLCDC_NV21_MODE			ATMEL_HLCDC_YCC_MODE(7)
#define ATMEL_HLCDC_YUV420_MODE			ATMEL_HLCDC_YCC_MODE(8)

#define ATMEL_HLCDC_LAYER_POS(x, y)		((x) | ((y) << 16))
#define ATMEL_HLCDC_LAYER_SIZE(w, h)		(((w) - 1) | (((h) - 1) << 16))

/* General Config Register Bits */
#define ATMEL_HLCDC_LAYER_DMA			BIT(0)
#define ATMEL_HLCDC_LAYER_REP			BIT(1)
#define ATMEL_HLCDC_LAYER_CRKEY			BIT(2)
#define ATMEL_HLCDC_LAYER_DSTKEY		BIT(3)
#define ATMEL_HLCDC_LAYER_VIDPR			BIT(5)
#define ATMEL_HLCDC_LAYER_SFACTC_SHIFT		6
#define ATMEL_HLCDC_LAYER_SFACTC(x)		\
	(((x) & 0x7) << ATMEL_HLCDC_LAYER_SFACTC_SHIFT)
#define ATMEL_HLCDC_LAYER_DFACTC_SHIFT		11
#define ATMEL_HLCDC_LAYER_DFACTC(x)		\
	(((x) & 0x7) << ATMEL_HLCDC_LAYER_DFACTC_SHIFT)
#define ATMEL_HLCDC_LAYER_DFACTA_SHIFT		14
#define ATMEL_HLCDC_LAYER_DFACTA(x)		\
	(((x) & 0x3) << ATMEL_HLCDC_LAYER_DFACTA_SHIFT)
#define ATMEL_HLCDC_LAYER_A0_SHIFT		16
#define ATMEL_HLCDC_LAYER_A0_MASK		\
	GENMASK(23, ATMEL_HLCDC_LAYER_A0_SHIFT)
#define ATMEL_HLCDC_LAYER_A0(x)			\
	((x) << ATMEL_HLCDC_LAYER_A0_SHIFT)
#define ATMEL_HLCDC_LAYER_A1_SHIFT		24
#define ATMEL_HLCDC_LAYER_A1_MASK		\
	GENMASK(31, ATMEL_HLCDC_LAYER_A1_SHIFT)
#define ATMEL_HLCDC_LAYER_A1(x)			\
	((x) << ATMEL_HLCDC_LAYER_A1_SHIFT)
