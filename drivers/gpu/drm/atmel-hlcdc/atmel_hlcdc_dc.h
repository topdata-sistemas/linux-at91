...
/* sam9x60 SOC and sam9x75 SOC LCD controller common registers */
...
/* sam9x75 SOC XLCDC controller specific registers */
#define ATMEL_XLCDC_UNUSED			0
#define ATMEL_XLCDC_LAYER_DMA_ROTDIS		ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_OVR			ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_ITER2BL		ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_ITER			ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_LAEN			ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_GAEN			ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_GA(x)			ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_DISCEN		ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_PLANE_HEAD(x)		ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_PLANE_CTRL(x)		ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_PLANE_NEXT(x)		ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_CHDR			ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_RST			ATMEL_XLCDC_UNUSED
#define ATMEL_XLCDC_LAYER_DFETCH		ATMEL_XLCDC_UNUSED

#define ATMEL_XLCDC_LAYER_CHER			0x10
#define ATMEL_XLCDC_LAYER_CHSR			0x10
#define ATMEL_XLCDC_LAYER_EN			BIT(0)
/*Bits aren't present but defining them like this saves code changes */
#define ATMEL_XLCDC_LAYER_UPDATE		BIT(0)
#define ATMEL_XLCDC_LAYER_A2Q			BIT(0)
...
#define ATMEL_XLCDC_LAYER_VIDPR			BIT(5)
#define ATMEL_XLCDC_LAYER_SFACTC_SHIFT		6
#define ATMEL_XLCDC_LAYER_SFACTC(x)		\
	(((x) & 0x7) << ATMEL_XLCDC_LAYER_SFACTC_SHIFT)
#define ATMEL_XLCDC_LAYER_DFACTC_SHIFT		11
#define ATMEL_XLCDC_LAYER_DFACTC(x)		\
	(((x) & 0x7) << ATMEL_XLCDC_LAYER_DFACTC_SHIFT)
#define ATMEL_XLCDC_LAYER_DFACTA_SHIFT		14
#define ATMEL_XLCDC_LAYER_DFACTA(x)		\
	(((x) & 0x3) << ATMEL_XLCDC_LAYER_DFACTA_SHIFT)
