...
#else
#define ATMEL_HLCDC_MODE_MASK		GENMASK(10, 8)
#define ATMEL_HLCDC_DPI			BIT(11)
#endif
...
#define ATMEL_HLCDC_ATTRE		0x3c

#define ATMEL_HLCDC_BASE_UPDATE		BIT(0)
#define ATMEL_HLCDC_OVR1_UPDATE		BIT(1)
#define ATMEL_HLCDC_OVR3_UPDATE		BIT(2)
#define ATMEL_HLCDC_HEO_UPDATE		BIT(3)
...
#define ATMEL_HLCDC_SD			BIT(5)
#define ATMEL_HLCDC_CM			BIT(6)
